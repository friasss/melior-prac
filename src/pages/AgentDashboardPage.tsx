        ...
        <div>
          {inquiries.length === 0 ? (
            <div className="card flex flex-col items-center gap-4 py-16 text-center">
              ...
              <p className="text-sm text-slate-500">Cuando los clientes envíen mensajes, aparecerán aquí.</p>
            </div>
          ) : (
                    ...
                    <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex flex-wrap items-center gap-3 mb-2">
                          <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-brand-100 font-bold text-brand-700 dark:bg-brand-900/50 dark:text-brand-300">
                        ...
                        {inq.subject && (
                          <p className="mb-1 text-xs font-semibold text-slate-500 dark:text-slate-400 uppercase tracking-wide">
                            {inq.subject}
                          </p>
                        )}
